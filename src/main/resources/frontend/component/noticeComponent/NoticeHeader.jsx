...
const NoticeHeader = ({titleValue, typeValue, authorValue, dateValue, hitValue}) => {
        ...
        <div className="row-cols-md-auto">
          <div className="board-wrapper">
            ...
            <div className="board-detail">
              ...
              <div className="board-subtitle">조회수</div>
              <div className="board-sub-content">{hitValue}</div>
            </div>
          </div>
        </div>
      </>
